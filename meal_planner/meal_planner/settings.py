...
SECRET_KEY = 'django-insecure-v6p6vwz7#ms+t&_vpu*=5^c4f_-d4jswd^-vu#(m5s+n^4xk96'
...
INSTALLED_APPS = [
    ...
    # Add the providers you want to enable, for example:
...
LOGIN_REDIRECT_URL = 'generate_meal_plan'
